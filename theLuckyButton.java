 ...
 */
public class theLuckyButton extends AsyncTask<String, Double, Book[]>{
    private Context context;
    private Activity parent;

    protected theLuckyButton(Context context, Activity parent){
    ...
    protected Book[] doInBackground(String... params) {
        ...
        try {
            Log.d("do in Background L", "L. really.");
            ...
            if(responseCode == HttpURLConnection.HTTP_OK) {
                ...
                try {
                    ...
                    Log.e("creating JSON",e.getMessage());
                }
    ...
    protected void onPostExecute(Book[] result){
                ...
                intent.putExtra("SELECTED", result[0].jsObj.toString());
